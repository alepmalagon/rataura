...
import os
from modal import App, Image, Secret, gpu, method
...
@app.cls(
    image=image,
    gpu=gpu.T4(),  # Use T4 GPU for inference (can be adjusted based on needs)
    secrets=[
...
@app.function(
    ...
    keep_warm=1,   # Keep one instance warm to reduce cold start times
)
