                ...
                if response.status == 200:
                    ...
                    for killmail in killmails:
                        try:
                            ...
                            final_blow_id = final_blow_attacker.get("character_id") if final_blow_attacker else None
                            final_blow_name = "Unknown"
                            final_blow_ship_type_id = final_blow_attacker.get("ship_type_id") if final_blow_attacker else None
...
FUNCTION_MAP = {
    ...
    "get_killmail_info": get_killmail_info,
}
