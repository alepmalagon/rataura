#!/usr/bin/env python3
"""
Debug script to test the direct web scraper and save HTML files for inspection.
"""
...
from eve_wiggin.api.direct_web_scraper import get_direct_web_scraper, DEBUG_FOLDER
...
async def main():
    """
    Main function to test the direct web scraper.
    """
    logger.info(f"Debug folder: {DEBUG_FOLDER}")
    logger.info("Creating debug folder if it doesn't exist...")
    os.makedirs(DEBUG_FOLDER, exist_ok=True)
    
    logger.info("Getting direct web scraper instance...")
    scraper = get_direct_web_scraper()
